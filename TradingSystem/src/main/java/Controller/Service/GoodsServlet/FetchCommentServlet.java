...
import Controller.Dao.ProDao.FetchCommentDao;
...
public class FetchCommentServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        FetchCommentDao fetchCommentDao = new FetchCommentDao();
        commentlist=fetchCommentDao.FetchComment(proid);
        System.out.println("评论："+commentlist);
        resp.getWriter().write(gson.toJson(commentlist));
    }
    @Override
