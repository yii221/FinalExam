...
import Controller.Dao.ProDao.EditImageDao;
...
public class EditProImageServlet extends HttpServlet {
    // 上传配置
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //删除文件夹下的file文件
        List<String> Originimageurl=new ArrayList<>();
        EditImageDao editImageDao=new EditImageDao();
        Originimageurl=editImageDao.GetImageUrl(proid);
        for(String imageurl:Originimageurl){
            String deletePath = getServletContext().getRealPath("/");
            Path fullPath = Paths.get(deletePath, imageurl).normalize();
        ...
        //删除数据库中的原始路径
        boolean flag = false;
        flag=editImageDao.DeleteProImage(proid);
