...
import Controller.Dao.OrdersDao.FetchBoughtDao;
...
@WebServlet("/FetchBoughtServlet")
public class FetchBoughtServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        FetchBoughtDao fetchBoughtDao = new FetchBoughtDao();
        List<Order> orderlist = fetchBoughtDao.fetchBought(buyerid);
